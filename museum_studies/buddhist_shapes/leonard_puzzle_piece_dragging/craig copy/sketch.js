var assetFilenames = ['puzzleoutline_piece0.png','puzzleoutline_piece1.png','puzzleoutline_piece2.png','puzzleoutline_piece3.png','puzzleoutline_piece4.png','puzzleoutline_piece5.png'];
var assetImages = [];
var puzzlePieces = [];
...
function preload(){
  ...
  for(var i = 0; i < assetFilenames.length; i++) {
    assetImages.push(loadImage("assets/images/" + assetFilenames[i]));
  }
}
